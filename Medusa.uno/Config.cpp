...
static void from_json(const json& j, Config::RagebotGlobal& rg)
{
    ...
    read(j, "Fov", rg.fov);
    read(j, "Accuracy boost", rg.accuracyBoost);
}
static void from_json(const json& j, Config::Ragebot& r)
{
    ...
    read(j, "Hitboxes Priority", r.prior_hit);
...
static void from_json(const json& j, Config::Misc& m)
{
    ...
    read(j, "bSkinnyBoy", m.bSkinnyBoy);
    read(j, "iSkinnyBoy", m.iSkinnyBoy);
    ...
    read(j, "Skinnyboy", m.bSkinnyBoy);
    read(j, "Skinnyboy", m.iSkinnyBoy);
...
static void to_json(json& j, const Config::Misc& o)
{
    ...
    WRITE("bSkinnyBoy", bSkinnyBoy);
    WRITE("iSkinnyBoy", iSkinnyBoy);
