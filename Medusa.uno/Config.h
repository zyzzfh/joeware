...
public:
    ...
    KeyBind preferBodyAim{ std::string("Force baim"), KeyMode::Off };
    ...
    struct Misc {
        ...
        bool IshowLegitBot{ false };
         ...
         bool bSkinnyBoy = false;
         int iSkinnyBoy = 0;

         //RADIO
         int iRadioStation = 0;
         float flRadioVolume = 0.f;
         int iRadioMuteHotKey = 0;
         bool bEnableRadio = false; // 
         bool bDoUnload = false;

         bool bLimitScan = false;
