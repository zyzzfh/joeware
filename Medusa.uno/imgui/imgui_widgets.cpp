...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    auto topColor = ImColor(255, 255, 255, 255);
    auto bottomColor = ImColor(255, 255, 255, 255);
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    it_active_value->second = floorf((float)percent / 100.f * (frame_bb.Max.x - frame_bb.Min.x));
    ...
    window->DrawList->AddRectFilled(ImVec2(frame_bb.Min.x, frame_bb.Min.y), ImVec2(frame_bb.Max.x, frame_bb.Max.y), ImColor(22, 22, 22, (int)(g.Style.Alpha * 255)), 6);
    ...
    window->DrawList->AddRect(ImVec2(frame_bb.Min.x, frame_bb.Min.y), ImVec2(frame_bb.Max.x, frame_bb.Max.y), ImColor(30, 30, 30, (int)(g.Style.Alpha * 255)), 6);
    GetWindowDrawList()->AddCircleFilled(ImVec2(grab_bb.Min.x + 2, grab_bb.Min.y + 1), 6.f, ImColor(255, 255, 255), 36);
   // window->DrawList->AddCircleFilled(ImVec2(frame_bb.Min.x + (g.Style.Alpha * it_old_value->second), frame_bb.Min.y + 3.5f), 6, GetColorU32(ImGuiCol_SliderGrabActive, (int)(g.Style.Alpha * 255)));
